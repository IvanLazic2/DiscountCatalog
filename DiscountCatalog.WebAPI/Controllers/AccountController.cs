...
namespace DiscountCatalog.WebAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [AllowAnonymous]
        [Route("Register")]
        public async Task<Result> Register(RegisterBindingModel model)
        {
        ...
        [AllowAnonymous]
        [Route("Authenticate")]
        public async Task<AuthenticatedUserResult> Authenticate(AuthenticationBindingModel model)
        {
            var result = new AuthenticatedUserResult();

            using (var uow = new UnitOfWork(new ApplicationUserDbContext()))
            {
                result = await uow.Accounts.Authenticate(model.EmailOrUserName, model.Password);
            }
        ...
        public IHttpActionResult Details(string id)
        {
            using (var uow = new UnitOfWork(new ApplicationUserDbContext()))
            {
                var user = uow.Accounts.GetApproved(id);
        ...
        [HttpPut]
        [Route("Edit/{id}")]
        public async Task<IHttpActionResult> Edit(string id, UserBindingModel model)
        {
            using (var uow = new UnitOfWork(new ApplicationUserDbContext()))
            {
